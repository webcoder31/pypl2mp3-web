...
> - **`verbose=True, use_default_verbosity=False` font partie du dictionnaire de `create_from_youtube`** : sans eux, `song.py:632-723` réassigne les quinze callbacks à ses propres closures d'affichage et écrit ses barres ANSI sur stdout.
